			...
			<div className={styles.cardContainer}>
				...
				<WorkCard
					work={{
						...
						description: "友人との日程調整をストレスフリーにする¥nモバイルアプリを開発中です。¥nスケジュール帳に基づいた日程調整機能などを開発中です。",
			...
			<div className={styles.cardContainer}>
				<WorkCard
					work={{
						...
						title: "ポートフォリオサイト",
						platform: "Webサイト",
						usedService: ["Typescript", "React", "Next.js", "HTML/CSS", "Figma"],
				...
				<WorkCard
					work={{
						...
						description: "人生で初めて開発したWebサイトです。¥nプログラミングを好きになったきっかけでもあります。¥nPure JavaScriptを用いて0から実装しました。",
